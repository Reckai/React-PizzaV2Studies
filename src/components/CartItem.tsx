...
const CartItem: React.FC<CartItemProps> = ({ id, title, size, price, count, imageUrl, type }) => {
  ...
  const onClickX = () => {
    if (window.confirm('Вы точно хотите удалить пиццу?')) {
  ...
  return (
    <div className="cart__item">
      ...
      <div onClick={onClickX} className="cart__item-remove">
